...
test('checkv()', function (t) {
    var int = tbase.lookup('int')
    t.table_assert([
        [ 'props',                 'v',            'null_ok', 'quiet', 'exp' ],
        '# check any',
        [ '*',                     'x',            false,      1,       [ true, null ] ],
        [ '*',                     'x',            false,      0,       [ true, null ] ],
        [ '*',                     'func',         false,      1,       [ false, null ] ],
        [ '*',                     'func',         false,      0,       [ null, 'not a value: function () {}' ] ],
        '# check string',
        [ 'str',                   'x',            false,      1,       [ true, null ] ],
        [ 'str',                   'x',            false,      0,       [ true, null ] ],
        [ 'str',                   null,           false,      1,       [ false, null ] ],
        [ 'str',                   7,              false,      0,       [ null, 'not a string: 7' ] ],
        '# check byte',
        [ 'byt',                   0,              false,      1,       [ true, null ] ],
        [ 'byt',                   255,            false,      0,       [ true, null ] ],
        [ 'byt',                   null,           false,      1,       [ false, null ] ],
        [ 'byt',                   -256,           false,      1,       [ false, null ] ],
        [ 'byt',                   -1,             false,      0,       [ null, 'not a byte: -1' ] ],
        '# check integer',
        [ 'int',                   0,              false,      1,       [ true, null ] ],
        [ 'int',                   -1,             false,      0,       [ true, null ] ],
        [ 'int',                   null,           false,      1,       [ false, null ] ],
        [ 'int',                   'x',            false,      0,       [ null, 'not an integer: x' ] ],
        '# check float',
        [ 'flt',                   1.1,            false,      1,       [ true, null ] ],
        [ 'flt',                   0,              false,      0,       [ true, null ] ],
        [ 'flt',                   null,           false,      1,       [ false, null ] ],
        [ 'flt',                   'x',            false,      0,       [ null, 'not a float: x' ] ],
        '# check decimal',
        [ 'dec',                   0,              false,      1,       [ true, null ] ],
        [ 'dec',                   9,              false,      0,       [ true, null ] ],
        [ 'dec',                   null,           false,      1,       [ false, null ] ],
        [ 'dec',                   'x',            false,      0,       [ null, 'not a decimal: x' ] ],
        '# check number',
        [ 'num',                   0,              false,      1,       [ true, null ] ],
        [ 'num',                   7.1,            false,      0,       [ true, null ] ],
        [ 'num',                   null,           false,      1,       [ false, null ] ],
        [ 'num',                   'x',            false,      0,       [ null, 'not a number: x' ] ],
        '# check boolean',
        [ 'boo',                   false,          false,      1,       [ true, null ] ],
        [ 'boo',                   7,              false,      0,       [ true, null ] ],
        [ 'boo',                   'x',            false,      1,       [ false, null ] ],
        [ 'boo',                   null,           false,      0,       [ null, 'not a boolean: null' ] ],
        '# check blob',
        [ 'blb',                   [],             false,      1,       [ true, null ] ],
        [ 'blb',                   '0x3',          false,      0,       [ true, null ] ],
        [ 'blb',                   { $t: 'X' },    false,      0,       [ true, null ] ],
        [ 'blb',                   { $type: 'q' }, false,      1,       [ false, null ] ],
        [ 'blb',                   { $type: 'q' }, false,      0,       [ null, 'not a blob: [object Object]' ] ],
        [ 'blb',                   {},             false,      1,       [ false, null ] ],
        [ 'blb',                   {},             false,      0,       [ null, 'not a blob: [object Object]' ] ],
        [ 'blb',                   null,           false,      1,       [ false, null ] ],
        [ 'blb',                   7,              false,      1,       [ false, null ] ],
        [ 'blb',                   '03',           false,      1,       [ false, null ] ],
        [ 'blb',                   null,           false,      0,       [ null, 'not a blob: null' ] ],
        [ 'blb',                   7,              false,      0,       [ null, 'not a blob: 7' ] ],
        [ 'blb',                   '03',           false,      0,       [ null, 'not a blob: 03' ] ],
        '# check array',
        [ 'arr',                   [],             false,      1,       [ true, null ] ],
        [ 'arr',                   [],             false,      0,       [ true, null ] ],
        [ 'arr',                   null,           false,      1,       [ false, null ] ],
        [ 'arr',                   0,              false,      0,       [ null, 'not an array: 0' ] ],
        '# check object',
        [ 'obj',                   {},             false,      1,       [ true, null ] ],
        [ 'obj',                   {},             false,      0,       [ true, null ] ],
        [ 'obj',                   null,           false,      1,       [ false, null ] ],
        [ 'obj',                   0,              false,      0,       [ null, 'not an object: 0' ] ],
        '# check multi-type',
        [ { mul: ['int'] },        0,              false,      1,       [ true, null ] ],
        [ { mul: ['str'] },        'x',            false,      0,       [ true, null ] ],
        [ { mul: ['int', 'str'] }, [],             false,      1,       [ false, null ] ],
        [ { mul: ['int', 'str'] }, null,           false,      0,       [ null, 'does not match multi-type: null: {"$mul":["int","str"]}' ] ],
    ], function (props, v, null_ok, quiet) {
